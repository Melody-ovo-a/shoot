...
int main(void)
{
  ...
  while (1)
  {
    ...
    Tx_2 = freq2 / 48 * 60;
    Tx_3 = freq3 / 48 * 60;
    // if (Tx_1 > 800) Tx_1 = 800; // 限制电机1转速
    // if (Tx_2 > 600) Tx_2 = 600; // 限制电机2转速
    // if (Tx_3 > 600) Tx_3 = 600; // 限制电机3转速
    // PID闭环调速，目标转速为600RPM
    output_pid[0] = PID_calc(&Motor_pid[0], Tx_1, 800);
    ...
    //发送数据到上位机，便于调试和监控
         serialplot.Set_Data(3, &Tx_1, &output_pid[0], &Tx_3);
